...
static struct module_pin_mux uart4_pin_mux[] = {
	/* enable UART4 that's routed to our serial debug header */
	{OFFSET(uart0_ctsn), (MODE(1) | PULLUP_EN | RXACTIVE)},	/* UART0_RXD = UART0_CTS = GPIO1_8 */
	{OFFSET(uart0_rtsn), (MODE(1) | PULLUDEN)},		/* UART0_TXD = UART0_RTS = GPIO1_9 */
	{-1},
};
...
void enable_board_pin_mux()
{
	...
	puts("\nApplied pin-mux for BeagleClone-Citifyd!\n");
	//hang();
}
