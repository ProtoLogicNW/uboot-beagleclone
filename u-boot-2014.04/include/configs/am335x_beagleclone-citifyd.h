...
#ifndef __CONFIG_AM335X_BEAGLECLONE_H
#define __CONFIG_AM335X_BEAGLECLONE_H
...
#define CONFIG_SYS_LDSCRIPT		"board/ti/beagleclone-citifyd/u-boot.lds"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"s6=0x4B0000\0"\
	"z6=0xB4FFFF\0"\
	"bootdbg=earlyprintk=serial,ttyO4,115200\0" \
	...
	"dtb=am335x-beagleclone-citifyd.dtb\0"\
	"sfs=beagleclone_boot.sfs\0"\
	"bootargs_spi=console=ttyO4,115200n8 root=/dev/ram0 rw ramdisk_size=65536 initrd=0x82000000,32M rootfstype=squashfs earlyprintk=serial,ttyO4,115200 consoleblank=0\0"\
	"bootargs_sfs=console=ttyO4,115200n8 root=/dev/ram0 rw initrd=0x82000000,4M init=/linuxrc earlyprintk=serial,ttyO4,115200 consoleblank=0 panic=10\0"\
	"bootargs_mmc=console=ttyO4,115200n8 root=/dev/mmcblk0p2 rw rootwait earlyprintk=serial,ttyO4,115200 consoleblank=0\0"\
	...
	"beagleclone_boot=mmc dev 0; if fatload mmc :1 0x815f0000 ${dtb}; then run boot_mmc2; else run boot_spi; fi;\0"\
	...
	DFUARGS
#define CONFIG_BOOTCOMMAND  "run beagleclone_boot;" 
...
#endif	/* ! __CONFIG_AM335X_BEAGLECLONE_H */
