...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boot_mmc=mmc dev 0; mmc rescan; fatload mmc :1 0x80300000 zImage; fatload mmc :1 0x815f0000 am335x-bonephone.dtb; setenv bootargs ${bootargs_mmc}; bootz 0x80300000 - 0x815f0000;\0"\
